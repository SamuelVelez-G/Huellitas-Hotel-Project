            ...
            <div class="footer-brand">
                ...
                <div class="footer-social">
                    ...
                    <a href="#" class="social-icon" aria-label="WhatsApp de Huellitas Hotel" target="_blank"
                        ...
                        <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true">
                            <path fill="currentColor"
                                d="M12 2.2A9.8 9.8 0 0 0 3.6 17l-1.3 4.8 4.9-1.3A9.8 9.8 0 1 0 12 2.2zm0 1.8a8 8 0 0 1 6.9 12l-.2.4.7 2.6-2.6-.7-.4.2A8 8 0 1 1 12 4zm-3.2 4.1c-.2 0-.5.1-.7.3-.2.3-.9.8-.9 2s.9 2.4 1 2.6c.1.1 1.8 2.9 4.5 4a10 10 0 0 0 1.6.6c.7.2 1.3.2 1.8.1.5-.1 1.6-.6 1.8-1.3.2-.6.2-1.1.2-1.2-.1-.1-.3-.2-.6-.3l-1.6-.8c-.2-.1-.4-.1-.6.1l-.7.9c-.1.1-.3.2-.5.1-.2-.1-1-.4-1.9-1.2-.7-.6-1.2-1.4-1.4-1.7-.1-.2 0-.4.1-.5l.4-.5c.1-.2.2-.3.1-.5-.1-.2-.6-1.6-.9-2.1-.2-.5-.4-.4-.6-.4h-.5z" />
                        </svg>
                    </a>
                </div>
            </div>
